...
datasets = {
    ...
    {'Experimental Data/6Keggwhite_zspectra.mat', 'eggdb19', 'offset', '1band', 13.8, '6K Egg dB19'}; % wrong
    ...
    %{'Experimental Data/6Keggwhite_zspectra.mat', 'eggdb43', 'offset', '1band', 1.22, '6K Egg dB43'}; % wrong
    %{'Experimental Data/6Keggwhite_zspectra.mat', 'eggdboff', 'offset', '1band', 0, '6K Egg dBoff'};
    
    % File 2: 10Kegg_zspectra.mat
    %{'Experimental Data/10Kegg_zspectra.mat', 'egg31dbpos', 'offset', '1band', 3.45, '10K Egg 31dB single'};
    %{'Experimental Data/10Kegg_zspectra.mat', 'egg31dbneg', 'offset', '1band', 3.45, '10K Egg 31dB single'};
    {'Experimental Data/10Kegg_zspectra.mat', 'egg28dbdual', 'offset', '2band', 4.88, '10K Egg 28dB dual'}; %correct
    ...
    {'Experimental Data/0716eggwhite2.mat', 'egg16dbdualart', 'offsetart', '2band', 19.52, '0716 Egg 16dB dual art'}; % wrong
    % 
    ...
    {'Experimental Data/0716eggwhite.mat', 'egg22dbdual', 'offset', '2band', 9.76, '0716 Egg 22dB dual'}; %correct
};
%% Pulse parameters
